...
public class UnshadedSimpleModelledCircle extends SimpleModelledCircle {

    public UnshadedSimpleModelledCircle(AssetManager assetManager, String backTexturePath, ColorRGBA sideColor) {
